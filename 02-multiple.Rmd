...
\begin{cases}
  ...
  \mu = \text{overall mean} \\
  \tau_j = j \text{-th treatment effect} := \mu_i - \mu
\end{cases}
$$
...
i.e. linearly independent. This design matrix $X$ is of rank deficient. Hence, the normal equation $(X^TX)^{-1}\hb = X^T \mathbf{Y}$ does *not have a unique solution*. This kind of coding is not appropriate.
