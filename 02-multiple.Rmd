...
| **end**
|"
alggsstr <- paste0("Algorithm", alggs, ": Gram-schmidt process")
```
...
| **end**
|"
algqrstr <- paste0("Algorithm", algqr, ": QR decomposition for modified G-S process")
```
...
| **end**
|"
algorthstr <- paste0("Algorithm", algorth, ": Successive orthogonalization")
```
...
|"
algseqstr <- paste0("Algorithm", algseq, ": Sequential F Test from beginning")
```
...
i.e. column vectors are linearly dependent. This design matrix $X$ is of rank deficient. Hence, the normal equation $(X^TX)^{-1}\hb = X^T \mathbf{Y}$ does *not have a unique solution*. This kind of coding is not appropriate. @Rawlings:2006aa provides four ways *reparameterizing* to remove singularities.
