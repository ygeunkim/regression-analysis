...
In the above linear system, subtract every line to the first. Then we can get
...
Thus for each line of the system,
...
\begin{equation}
  \begin{cases}
    ...
    \vdots \\
    \hat\tau_{k - 1} = \overline{Y}_{k - 1} - \overline{Y}_{k - 1}
  \end{cases}
  (\#eq:dummycodecoef)
\end{equation}
