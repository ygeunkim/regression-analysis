...
\StringTok{ }\DecValTok{1}     \DecValTok{3}     \DecValTok{4}
 \DecValTok{2}     \DecValTok{8}     \DecValTok{7}
 \DecValTok{3}    \DecValTok{10}     \DecValTok{8}
 \DecValTok{4}    \DecValTok{11}     \DecValTok{8}
 \DecValTok{5}    \DecValTok{13}    \DecValTok{10}
 \DecValTok{6}    \DecValTok{16}    \DecValTok{11}
 \DecValTok{7}    \DecValTok{27}    \DecValTok{16}
 \DecValTok{8}    \DecValTok{30}    \DecValTok{26}
 \DecValTok{9}    \DecValTok{35}    \DecValTok{21}
\DecValTok{10}    \DecValTok{37}     \DecValTok{9}
\DecValTok{11}    \DecValTok{38}    \DecValTok{31}
\DecValTok{12}    \DecValTok{44}    \DecValTok{30}
\DecValTok{13}   \DecValTok{103}    \DecValTok{75}
\DecValTok{14}   \DecValTok{142}    \DecValTok{90}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{lm}\NormalTok{(}\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{x, }\DataTypeTok{data =}\NormalTok{ delv)}

\NormalTok{Coefficients}\OperatorTok{:}
\NormalTok{(Intercept)            x  }
       \FloatTok{3.32}         \FloatTok{2.18}  
\end{Highlighting}
\end{Shaded}
...
\FloatTok{-1.874}  \FloatTok{1.651}  \FloatTok{2.181}  \FloatTok{2.855} \FloatTok{-2.628} \FloatTok{-0.444}  \FloatTok{0.327} \FloatTok{-0.724} \FloatTok{10.634}  \FloatTok{7.298} 
    \DecValTok{11}     \DecValTok{12}     \DecValTok{13}     \DecValTok{14}     \DecValTok{15}     \DecValTok{16}     \DecValTok{17}     \DecValTok{18}     \DecValTok{19}     \DecValTok{20} 
 \FloatTok{2.191} \FloatTok{-4.082}  \FloatTok{1.475}  \FloatTok{3.372}  \FloatTok{1.094}  \FloatTok{3.918} \FloatTok{-1.028}  \FloatTok{0.446} \FloatTok{-0.349} \FloatTok{-5.216} 
    \DecValTok{21}     \DecValTok{22}     \DecValTok{23}     \DecValTok{24}     \DecValTok{25} 
\FloatTok{-7.182} \FloatTok{-7.581} \FloatTok{-4.156} \FloatTok{-0.900} \FloatTok{-1.275} 
\end{Highlighting}
\end{Shaded}
...
\StringTok{ }\DecValTok{1}  \FloatTok{16.7}     \DecValTok{7} \FloatTok{18.6} 
 \DecValTok{2}  \FloatTok{11.5}     \DecValTok{3}  \FloatTok{9.85}
 \DecValTok{3}  \FloatTok{12.0}     \DecValTok{3}  \FloatTok{9.85}
 \DecValTok{4}  \FloatTok{14.9}     \DecValTok{4} \FloatTok{12.0} 
 \DecValTok{5}  \FloatTok{13.8}     \DecValTok{6} \FloatTok{16.4} 
 \DecValTok{6}  \FloatTok{18.1}     \DecValTok{7} \FloatTok{18.6} 
 \DecValTok{7}   \DecValTok{8}       \DecValTok{2}  \FloatTok{7.67}
 \DecValTok{8}  \FloatTok{17.8}     \DecValTok{7} \FloatTok{18.6} 
 \DecValTok{9}  \FloatTok{79.2}    \DecValTok{30} \FloatTok{68.6} 
\DecValTok{10}  \FloatTok{21.5}     \DecValTok{5} \FloatTok{14.2} 
...
\FloatTok{-7.581} \FloatTok{-1.874} \FloatTok{-0.349}  \FloatTok{2.181} \FloatTok{10.634} 
...
\NormalTok{(Intercept)    }\FloatTok{3.321}      \FloatTok{1.371}    \FloatTok{2.42}    \FloatTok{0.024} \OperatorTok{*}\StringTok{  }
\NormalTok{x              }\FloatTok{2.176}      \FloatTok{0.124}   \FloatTok{17.55}  \FloatTok{8.2e-15} \OperatorTok{**}\ErrorTok{*}
\OperatorTok{---}
...
\NormalTok{Residual standard error}\OperatorTok{:}\StringTok{ }\FloatTok{4.18}\NormalTok{ on }\DecValTok{23}\NormalTok{ degrees of freedom}
\NormalTok{Multiple R}\OperatorTok{-}\NormalTok{squared}\OperatorTok{:}\StringTok{  }\FloatTok{0.93}\NormalTok{,  Adjusted R}\OperatorTok{-}\NormalTok{squared}\OperatorTok{:}\StringTok{  }\FloatTok{0.927} 
\NormalTok{F}\OperatorTok{-}\NormalTok{statistic}\OperatorTok{:}\StringTok{  }\DecValTok{308}\NormalTok{ on }\DecValTok{1}\NormalTok{ and }\DecValTok{23}\NormalTok{ DF,  p}\OperatorTok{-}\NormalTok{value}\OperatorTok{:}\StringTok{ }\FloatTok{8.22e-15}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{1}\NormalTok{ (Intercept)     }\FloatTok{3.32}     \FloatTok{1.37}       \FloatTok{2.42} \FloatTok{2.37}\NormalTok{e}\OperatorTok{-}\StringTok{ }\DecValTok{2}
\DecValTok{2}\NormalTok{ x               }\FloatTok{2.18}     \FloatTok{0.124}     \FloatTok{17.5}  \FloatTok{8.22e-15}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{(Intercept) }\FloatTok{0.484}   \FloatTok{6.16}
\NormalTok{x           }\FloatTok{1.920}   \FloatTok{2.43}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{     fit   lwr   upr}
   \OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\StringTok{ }\DecValTok{1} \FloatTok{18.6}  \FloatTok{16.8}   \FloatTok{20.3}
 \DecValTok{2}  \FloatTok{9.85}  \FloatTok{7.57}  \FloatTok{12.1}
 \DecValTok{3}  \FloatTok{9.85}  \FloatTok{7.57}  \FloatTok{12.1}
 \DecValTok{4} \FloatTok{12.0}   \FloatTok{9.91}  \FloatTok{14.1}
 \DecValTok{5} \FloatTok{16.4}  \FloatTok{14.5}   \FloatTok{18.2}
 \DecValTok{6} \FloatTok{18.6}  \FloatTok{16.8}   \FloatTok{20.3}
 \DecValTok{7}  \FloatTok{7.67}  \FloatTok{5.22}  \FloatTok{10.1}
 \DecValTok{8} \FloatTok{18.6}  \FloatTok{16.8}   \FloatTok{20.3}
 \DecValTok{9} \FloatTok{68.6}  \FloatTok{62.9}   \FloatTok{74.3}
\DecValTok{10} \FloatTok{14.2}  \FloatTok{12.2}   \FloatTok{16.2}
\CommentTok{# ... with 15 more rows}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{   fit  lwr  upr}
\DecValTok{1} \FloatTok{70.8} \FloatTok{60.3} \FloatTok{81.3}
\DecValTok{2} \FloatTok{73.0} \FloatTok{62.3} \FloatTok{83.6}
\DecValTok{3} \FloatTok{75.1} \FloatTok{64.3} \FloatTok{85.9}
\DecValTok{4} \FloatTok{77.3} \FloatTok{66.4} \FloatTok{88.3}
\DecValTok{5} \FloatTok{79.5} \FloatTok{68.4} \FloatTok{90.6}
\end{Highlighting}
\end{Shaded}
...
\begin{enumerate}
  \item $A^n$ is also idempotent
  \item $I - A$ is also idempotent
  \item Every eigenvalue of $A$ is either $0$ or $1$ so that $tr(A) = rank(A)$
\end{enumerate}
\EndKnitrBlock{theorem}
...
\NormalTok{value numdf dendf }
  \DecValTok{308}     \DecValTok{1}    \DecValTok{23} 
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Response}\OperatorTok{:}\StringTok{ }\NormalTok{y}
\NormalTok{          Df Sum Sq Mean Sq F value  }\KeywordTok{Pr}\NormalTok{(}\OperatorTok{>}\NormalTok{F)    }
\NormalTok{x          }\DecValTok{1}   \DecValTok{5382}    \DecValTok{5382}     \DecValTok{308} \FloatTok{8.2e-15} \OperatorTok{**}\ErrorTok{*}
\NormalTok{Residuals }\DecValTok{23}    \DecValTok{402}      \DecValTok{17}                    
\OperatorTok{---}
\NormalTok{Signif. codes}\OperatorTok{:}\StringTok{  }\DecValTok{0} \StringTok{'***'} \FloatTok{0.001} \StringTok{'**'} \FloatTok{0.01} \StringTok{'*'} \FloatTok{0.05} \StringTok{'.'} \FloatTok{0.1} \StringTok{' '} \DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  term         df sumsq meansq statistic   p.value}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{     }\ErrorTok{<}\NormalTok{int}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{     }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{     }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ x             }\DecValTok{1} \FloatTok{5382.} \FloatTok{5382.}       \FloatTok{308.}  \FloatTok{8.22e-15}
\DecValTok{2}\NormalTok{ Residuals    }\DecValTok{23}  \FloatTok{402.}   \FloatTok{17.5}       \OtherTok{NA}  \OtherTok{NA}       
\end{Highlighting}
\end{Shaded}
...
\NormalTok{       y    x1    x2    x3    x4}
   \OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\StringTok{ }\DecValTok{1}  \FloatTok{78.5}     \DecValTok{7}    \DecValTok{26}     \DecValTok{6}    \DecValTok{60}
 \DecValTok{2}  \FloatTok{74.3}     \DecValTok{1}    \DecValTok{29}    \DecValTok{15}    \DecValTok{52}
 \DecValTok{3} \FloatTok{104.}     \DecValTok{11}    \DecValTok{56}     \DecValTok{8}    \DecValTok{20}
 \DecValTok{4}  \FloatTok{87.6}    \DecValTok{11}    \DecValTok{31}     \DecValTok{8}    \DecValTok{47}
 \DecValTok{5}  \FloatTok{95.9}     \DecValTok{7}    \DecValTok{52}     \DecValTok{6}    \DecValTok{33}
 \DecValTok{6} \FloatTok{109.}     \DecValTok{11}    \DecValTok{55}     \DecValTok{9}    \DecValTok{22}
 \DecValTok{7} \FloatTok{103.}      \DecValTok{3}    \DecValTok{71}    \DecValTok{17}     \DecValTok{6}
 \DecValTok{8}  \FloatTok{72.5}     \DecValTok{1}    \DecValTok{31}    \DecValTok{22}    \DecValTok{44}
 \DecValTok{9}  \FloatTok{93.1}     \DecValTok{2}    \DecValTok{54}    \DecValTok{18}    \DecValTok{22}
\DecValTok{10} \FloatTok{116.}     \DecValTok{21}    \DecValTok{47}     \DecValTok{4}    \DecValTok{26}
\DecValTok{11}  \FloatTok{83.8}     \DecValTok{1}    \DecValTok{40}    \DecValTok{23}    \DecValTok{34}
\DecValTok{12} \FloatTok{113.}     \DecValTok{11}    \DecValTok{66}     \DecValTok{9}    \DecValTok{12}
\DecValTok{13} \FloatTok{109.}     \DecValTok{10}    \DecValTok{68}     \DecValTok{8}    \DecValTok{12}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{(Intercept) }\FloatTok{62.405}
\NormalTok{x1           }\FloatTok{1.551}
\NormalTok{x2           }\FloatTok{0.510}
\NormalTok{x3           }\FloatTok{0.102}
\NormalTok{x4          }\FloatTok{-0.144}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Call}\OperatorTok{:}
\KeywordTok{lm}\NormalTok{(}\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{~}\StringTok{ }\NormalTok{., }\DataTypeTok{data =}\NormalTok{ cem)}

\NormalTok{Coefficients}\OperatorTok{:}
\NormalTok{(Intercept)           x1           x2           x3           x4  }
     \FloatTok{62.405}        \FloatTok{1.551}        \FloatTok{0.510}        \FloatTok{0.102}       \FloatTok{-0.144}  
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Residuals}\OperatorTok{:}
\StringTok{   }\NormalTok{Min     1Q Median     3Q    Max }
\FloatTok{-3.175} \FloatTok{-1.671}  \FloatTok{0.251}  \FloatTok{1.378}  \FloatTok{3.925} 

\NormalTok{Coefficients}\OperatorTok{:}
\StringTok{            }\NormalTok{Estimate Std. Error t value }\KeywordTok{Pr}\NormalTok{(}\OperatorTok{>}\ErrorTok{|}\NormalTok{t}\OperatorTok{|}\NormalTok{)  }
\NormalTok{(Intercept)   }\FloatTok{62.405}     \FloatTok{70.071}    \FloatTok{0.89}    \FloatTok{0.399}  
\NormalTok{x1             }\FloatTok{1.551}      \FloatTok{0.745}    \FloatTok{2.08}    \FloatTok{0.071}\NormalTok{ .}
\NormalTok{x2             }\FloatTok{0.510}      \FloatTok{0.724}    \FloatTok{0.70}    \FloatTok{0.501}  
\NormalTok{x3             }\FloatTok{0.102}      \FloatTok{0.755}    \FloatTok{0.14}    \FloatTok{0.896}  
\NormalTok{x4            }\FloatTok{-0.144}      \FloatTok{0.709}   \FloatTok{-0.20}    \FloatTok{0.844}  
\OperatorTok{---}
\NormalTok{Signif. codes}\OperatorTok{:}\StringTok{  }\DecValTok{0} \StringTok{'***'} \FloatTok{0.001} \StringTok{'**'} \FloatTok{0.01} \StringTok{'*'} \FloatTok{0.05} \StringTok{'.'} \FloatTok{0.1} \StringTok{' '} \DecValTok{1}

\NormalTok{Residual standard error}\OperatorTok{:}\StringTok{ }\FloatTok{2.45}\NormalTok{ on }\DecValTok{8}\NormalTok{ degrees of freedom}
\NormalTok{Multiple R}\OperatorTok{-}\NormalTok{squared}\OperatorTok{:}\StringTok{  }\FloatTok{0.982}\NormalTok{, Adjusted R}\OperatorTok{-}\NormalTok{squared}\OperatorTok{:}\StringTok{  }\FloatTok{0.974} 
\NormalTok{F}\OperatorTok{-}\NormalTok{statistic}\OperatorTok{:}\StringTok{  }\DecValTok{111}\NormalTok{ on }\DecValTok{4}\NormalTok{ and }\DecValTok{8}\NormalTok{ DF,  p}\OperatorTok{-}\NormalTok{value}\OperatorTok{:}\StringTok{ }\FloatTok{4.76e-07}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{value numdf dendf }
  \DecValTok{111}     \DecValTok{4}     \DecValTok{8} 
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Response}\OperatorTok{:}\StringTok{ }\NormalTok{y}
\NormalTok{          Df Sum Sq Mean Sq F value  }\KeywordTok{Pr}\NormalTok{(}\OperatorTok{>}\NormalTok{F)    }
\NormalTok{x1         }\DecValTok{1}   \DecValTok{1450}    \DecValTok{1450}  \FloatTok{242.37} \FloatTok{2.9e-07} \OperatorTok{**}\ErrorTok{*}
\NormalTok{x2         }\DecValTok{1}   \DecValTok{1208}    \DecValTok{1208}  \FloatTok{201.87} \FloatTok{5.9e-07} \OperatorTok{**}\ErrorTok{*}
\NormalTok{x3         }\DecValTok{1}     \DecValTok{10}      \DecValTok{10}    \FloatTok{1.64}    \FloatTok{0.24}    
\NormalTok{x4         }\DecValTok{1}      \DecValTok{0}       \DecValTok{0}    \FloatTok{0.04}    \FloatTok{0.84}    
\NormalTok{Residuals  }\DecValTok{8}     \DecValTok{48}       \DecValTok{6}                    
\OperatorTok{---}
\NormalTok{Signif. codes}\OperatorTok{:}\StringTok{  }\DecValTok{0} \StringTok{'***'} \FloatTok{0.001} \StringTok{'**'} \FloatTok{0.01} \StringTok{'*'} \FloatTok{0.05} \StringTok{'.'} \FloatTok{0.1} \StringTok{' '} \DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.7\linewidth]{regression-analysis_files/figure-latex/unnamed-chunk-86-1} \end{center}
...
\[\Big\{ \boldsymbol\beta_A : (\boldsymbol{\hat\beta}_A - \boldsymbol\beta_A)^T \mathbb{X}_{A, \perp}^T\mathbb{X}_{A, \perp} (\boldsymbol{\hat\beta}_A - \boldsymbol\beta_A) \le p \hat\sigma^2 F_{1 - \alpha}(p, n - p - 1) \Big\}\]
...
For Example \ref{exm:ftestex}, the basic starting model, i.e.~FM is
...
Note that \(SST = \sum\limits_{i = 1}^n(Y_i - \overline{Y})^2\) does not depend on model, i.e.~consistent with given data.
...
\(SSE\) indicates a variation that cannot be explained by the model. \(SSR\) represents a variation explained by the model. We can compare these between the two model. If \(SSE(RM) - SSE(FM) = SSR(FM) - SSR(RM)\) is large, then we can think that the full model is explaining given data better than reduced model. In terms of \(H_0: RM \:\text{vs}\: H_1: FM\), it can be said that it is a strong evidene supporting FM against RM. In turn, we conclude that \(H_1: \beta_{p - 1} \neq 0 \:\text{or}\: \beta_p \neq 0\) from our first hypothesis set.
...
We can test any hypothesis using RM-FM with Conjecture \ref{cnj:fmrmdist}. The question is
...
\begin{enumerate}
  ...
  \item $\Pi_X - \Pi_{Z_1} \perp\!\!\!\perp SSE(FM)$
\end{enumerate}
\EndKnitrBlock{lemma}
...
Hence, \(\Pi_X - \Pi_{Z_1} \perp\!\!\!\perp SSE(FM)\)
\EndKnitrBlock{proof}

Go back to our Example \ref{exm:ftestex}. Denote that \(\Pi_X - \Pi_{Z_1}\) implies that \(R_{p - 1}^2 > R_{p - 2}^2\). \(tr(\Pi_X - \Pi_{Z_1}) = (p + 1) - (p - 1) = 2\).
...
Since from Proposition \ref{prp:ssdist}
...
reject \(H_0\) if \(\frac{(SSR(FM) - SSR(RM)) / 2}{SSE(FM) / (n - p - 1)} > F_{1 - \alpha}(2, n - p - 1)\).

See the numerator part \(SSR(FM) - SSR(RM)\) we have been explored. This can be also written as

\[SSR(X_1, \ldots, X_p) - SSR(X_{p - 1}, X_{p})\]
...
This measures marginal contribution of \(X_2\) after \(X_1\) is considred. Here, the contribution means marginal increase of \(SSR\).
\EndKnitrBlock{definition}
...
\begin{enumerate}
  ...
  \item $SSR(X_1 \mid X_2, \mid X_p) + \cdots + SSR(X_p \mid X_1, \ldots, X_{p - 1}) \neq SSR(X_1, \ldots, X_p)$
...
Hence, reject \(H_0\) if \(F_0 > F_{1 - \alpha}(1, n - p - 1)\). Since the first degrees of freedom is \(1\), we have
...
\begin{equation}
  \frac{\Big(SSR(X_1, \ldots, X_p) - SSR(X_{q + 1}, \ldots, X_p)\Big) / (p - q)}{SSE(X_1, \ldots, X_p) / (n - p - 1)} > F_{1 - \alpha}(p - q, n - p - 1)
  \label{eq:seqgen}
\end{equation}
...
\[\mathbf{Z} \equiv \sigma (C(X^TX)^{-1}C^T)^{-\frac{1}{2}} (C \hat{\boldsymbol\beta} - \mathbf{d}) \stackrel{H_0}{\sim}MVN(\mathbf{0}, I)\]
...
\NormalTok{Response}\OperatorTok{:}\StringTok{ }\NormalTok{y}
\NormalTok{          Df Sum Sq Mean Sq F value  }\KeywordTok{Pr}\NormalTok{(}\OperatorTok{>}\NormalTok{F)    }
\NormalTok{x2         }\DecValTok{1}   \DecValTok{1809}    \DecValTok{1809}  \FloatTok{302.43} \FloatTok{1.2e-07} \OperatorTok{**}\ErrorTok{*}
\NormalTok{x1         }\DecValTok{1}    \DecValTok{848}     \DecValTok{848}  \FloatTok{141.81} \FloatTok{2.3e-06} \OperatorTok{**}\ErrorTok{*}
\NormalTok{x3         }\DecValTok{1}     \DecValTok{10}      \DecValTok{10}    \FloatTok{1.64}    \FloatTok{0.24}    
\NormalTok{x4         }\DecValTok{1}      \DecValTok{0}       \DecValTok{0}    \FloatTok{0.04}    \FloatTok{0.84}    
\NormalTok{Residuals  }\DecValTok{8}     \DecValTok{48}       \DecValTok{6}                    
\OperatorTok{---}
...
\NormalTok{(Intercept)    }\FloatTok{4.7}  \DecValTok{1}    \FloatTok{0.79}  \FloatTok{0.399}  
\NormalTok{x1            }\FloatTok{26.0}  \DecValTok{1}    \FloatTok{4.34}  \FloatTok{0.071}\NormalTok{ .}
\NormalTok{x2             }\FloatTok{3.0}  \DecValTok{1}    \FloatTok{0.50}  \FloatTok{0.501}  
\NormalTok{x3             }\FloatTok{0.1}  \DecValTok{1}    \FloatTok{0.02}  \FloatTok{0.896}  
\NormalTok{x4             }\FloatTok{0.2}  \DecValTok{1}    \FloatTok{0.04}  \FloatTok{0.844}  
\NormalTok{Residuals     }\FloatTok{47.9}  \DecValTok{8}                 
\OperatorTok{---}
\NormalTok{Signif. codes}\OperatorTok{:}\StringTok{  }\DecValTok{0} \StringTok{'***'} \FloatTok{0.001} \StringTok{'**'} \FloatTok{0.01} \StringTok{'*'} \FloatTok{0.05} \StringTok{'.'} \FloatTok{0.1} \StringTok{' '} \DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  term         sumsq    df statistic p.value}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{        }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{     }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{   }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ (Intercept)  }\FloatTok{4.75}      \DecValTok{1}    \FloatTok{0.793}   \FloatTok{0.399} 
\DecValTok{2}\NormalTok{ x1          }\FloatTok{26.0}       \DecValTok{1}    \FloatTok{4.34}    \FloatTok{0.0708}
\DecValTok{3}\NormalTok{ x2           }\FloatTok{2.97}      \DecValTok{1}    \FloatTok{0.497}   \FloatTok{0.501} 
\DecValTok{4}\NormalTok{ x3           }\FloatTok{0.109}     \DecValTok{1}    \FloatTok{0.0182}  \FloatTok{0.896} 
\DecValTok{5}\NormalTok{ x4           }\FloatTok{0.247}     \DecValTok{1}    \FloatTok{0.0413}  \FloatTok{0.844} 
\DecValTok{6}\NormalTok{ Residuals   }\FloatTok{47.9}       \DecValTok{8}   \OtherTok{NA}      \OtherTok{NA}     
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  p.value t_test}
    \OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{  }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}  \FloatTok{0.399}  \FloatTok{0.399} 
\DecValTok{2}  \FloatTok{0.0708} \FloatTok{0.0708}
\DecValTok{3}  \FloatTok{0.501}  \FloatTok{0.501} 
\DecValTok{4}  \FloatTok{0.896}  \FloatTok{0.896} 
\DecValTok{5}  \FloatTok{0.844}  \FloatTok{0.844} 
\end{Highlighting}
\end{Shaded}
