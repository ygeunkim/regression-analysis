...
We call each $\mathbf{v}_j$ and $\mathbf{u}_j$ *right singular vector* and *left singular vector*. Next, we see reduced SVD. This uses left upper block of $D$, i.e. it has dimension of $(p + 1) \times (p + 1)$.
