...
Consider centered input $\widetilde{\mathbb{X}}_A = \mathbb{X}_{A, \perp}$ facing with multicollinearity. Multicollinearity makes estimation unstable. **Ridge regression** shrinks unstable variance of coefficient $\frac{1}{\epsilon}$ to $\frac{1}{\epsilon + \kappa}$.
