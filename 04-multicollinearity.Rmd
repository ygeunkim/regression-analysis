...
\begin{equation}
  \B_{A, R} = \argmin_{\B_A} \bigg\{ (\mathbf{Y} - \widetilde{\mathbb{X}}_A \B_A)^T (\mathbf{Y} - \widetilde{\mathbb{X}}_A \B_A) + \kappa \B_A^T \B_A \bigg\}
  (\#eq:ridgeargmin)
\end{equation}
...
$$Q(\kappa) \equiv (\mathbf{Y} - \widetilde{\mathbb{X}}_A \B_A)^T (\mathbf{Y} - \widetilde{\mathbb{X}}_A \B_A) + \kappa \B_A^T \B_A$$
