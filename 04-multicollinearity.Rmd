...
$$E \hb_{A, R} = (\widetilde{\mathbb{X}}_A^T \widetilde{\mathbb{X}}_A + \kappa I)^{-1}\widetilde{\mathbb{X}}_A^T \widetilde{\mathbb{X}}_A \hb_{A} \neq \hb_A$$
```

```{proof}
Note that ridge estimator is linear function of $\mathbf{Y}$. Since $E\mathbf{Y} = \widetilde{\mathbb{X}}_A \hb_{A}$,
...
\begin{equation}
  \B_{A, R} = \argmin_{\B_A} \bigg\{ (\mathbf{Y} - \mathbf{1} \overline{Y} - \widetilde{\mathbb{X}}_A \B_A)^T (\mathbf{Y} - \mathbf{1} \overline{Y} - \widetilde{\mathbb{X}}_A \B_A) + \kappa \B_A^T \B_A \bigg\}
  (\#eq:ridgeargmin)
\end{equation}
...
\begin{equation}
  \B_{A, R} = \argmin_{\B_A} \bigg\{ \lVert \mathbf{Y} - \mathbf{1} \overline{Y} - \widetilde{\mathbb{X}}_A \B_A \rVert^2 + \kappa \lVert \B_A \rVert^2 \bigg\}
  (\#eq:ridgetikhonov)
\end{equation}
...
\begin{equation}
  \B_{A, R} = \argmin_{\B_A} \lVert \mathbf{Y} - \mathbf{1} \overline{Y} - \widetilde{\mathbb{X}}_A \B_A \rVert^2 \quad \text{subject to} \: \lVert \B_{A} \rVert^2 \le d
  (\#eq:ridgeivanov)
\end{equation}
...
\begin{equation*}
  \begin{split}
    \B_{A, R} & = \argmin_{\B_A \in \R^p} \lVert \mathbf{Y} - \mathbf{1} \overline{Y} - \widetilde{\mathbb{X}}_A \B_A \rVert^2 \quad \text{subject to} \: \lVert \B_{A} \rVert^2 \le d \\
...
\begin{equation}
  \begin{split}
    \B_{A, R} & = \argmin_{\B_A \in {\color{blue}{\partial}}\Omega_d} \lVert \mathbf{Y} - \mathbf{1} \overline{Y} - \widetilde{\mathbb{X}}_A \B_A \rVert^2 \\
...
\begin{equation}
  \lVert \hb_{A} \rVert^2 = \mathbf{Y}^T U diag\bigg( \frac{\sigma_j^2}{(\sigma_j^2 + \kappa)^2} \bigg) U^T \mathbf{Y} = d
  (\#eq:dvskappa)
\end{equation}
