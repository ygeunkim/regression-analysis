...
```{r circle1, echo=FALSE, fig.cap="A circle with radius 1"}
circ_dat %>% 
  draw_circle(aes(x, y))
```
...
```{r circle2, message=FALSE, echo=FALSE, fig.cap="$V^T \\mathbf{b}$"}
...
```{r circle3, message=FALSE, echo=FALSE, fig.cap="$D(V^T\\mathbf{b})$"}
...
```{r circle4, message=FALSE, echo=FALSE, fig.cap="$U(DV^T\\mathbf{b})$"}
